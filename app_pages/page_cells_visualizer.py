...
def page_cells_visualizer_body():
    ...
    st.info(
        ...
        f"differentiates a healty and powdery mildew leaves.")
    ...
    if st.checkbox("Difference between average and variability image"):
      ...
      st.warning(
        ...
        f"However, a difference in the colour pigment of the average images is seen for both labels.")

      st.image(avg_parasitized, caption='Powdery Mildew Leaves - Average and Variability')
      st.image(avg_uninfected, caption='Healty Leaves - Average and Variability')
      st.write("---")

    if st.checkbox("Differences between average Powdery Mildew and average Healty Leaves"):
