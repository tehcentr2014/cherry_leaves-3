...
def page_malaria_detector_body():
    st.info(
        f"* The client is interested in telling whether a given leaves contain a powdery mildew "
        f"or not."
        )

    st.write(
        f"* You can download a set of parasitised and uninfected leaves for live prediction. "
